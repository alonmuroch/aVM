...
#[macro_use]
pub mod storage;
pub use storage::PERSISTENT_DOMAIN;
pub use storage::Persistent; // Allow `$crate::Persistent` in macros // Allow `$crate::PERSISTENT_DOMAIN` in macros

// Router
pub mod router;
pub use router::{FuncCall, decode_calls, route};
